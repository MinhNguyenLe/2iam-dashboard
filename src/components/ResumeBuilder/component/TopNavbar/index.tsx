          ...
          return (
            <div
              ...
              className={[
                ...
                item === theme.color && styles.colorCircleItemActive,
              ].join(" ")}
              style={{
                background: item,
                borderColor: item,
      ...
      <div className={styles.sectionBox}>
        <div className={styles.sectionLeft}>
          <div className={styles.sectionItem}>
            ...
            <span
              className={styles.sectionItemText}
              onClick={() => this._switchBtnClick("picture")}
            >
              Picture
            </span>
          </div>
          <div className={styles.sectionItem}>
            ...
            <span
              className={styles.sectionItemText}
              onClick={() => this._switchBtnClick("info")}
            >
              Info
            </span>
          </div>
          <div className={styles.sectionItem}>
            ...
            <span
              className={styles.sectionItemText}
              onClick={() => this._switchBtnClick("profile")}
            >
              Profile
            </span>
          </div>
        ...
        <div className={styles.sectionRight}>
          <div className={styles.sectionItem}>
            ...
            <span
              className={styles.sectionItemText}
              onClick={() => this._switchBtnClick("workExperience")}
            >
              WorkExperience
            </span>
          </div>
          <div className={styles.sectionItem}>
            ...
            <span
              className={styles.sectionItemText}
              onClick={() => this._switchBtnClick("education")}
            >
              Education
            </span>
          </div>
          <div className={styles.sectionItem}>
            ...
            <span
              className={styles.sectionItemText}
              onClick={() => this._switchBtnClick("skills")}
            >
              Skills
            </span>
          </div>
        ...
        >
          ...
          <Modal.Body>
            <div className={styles.saveModal}>
              <p>
                By storing your information, in the future you can use it to
                edit your resume.
              </p>
          ...
          <Modal.Body>
            <div className={styles.loadModal}>
              ...
              {this.state.uploadErrMsg && (
                <span>Uploaded file format is wrong</span>
              )}
            </div>
          </Modal.Body>
        </Modal>
